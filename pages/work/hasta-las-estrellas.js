      ...
      <div className="text-black dark:text-white">
        <section className="md:grid grid-cols-2">
          <article className="my-8 md:m-16 md:max-w-lg">
            <h1 className="text-4xl lg:text-5xl leading-tight mb-8">
              Hasta las Estrellas
            </h1>

            <p>
              Ilustración aumentada. Dibujo con marcador de pintura blanca al
              agua sobre papel negro. Corte mecánico, pegado a mano; la
              precisión es maquínica, el error humano. Pantalla LCD con
              animación generada algorítmicamente.
            </p>
        ...
        <section className="container p-8 md:p-0 md:mx-auto md:my-24 md:grid grid-cols-2">
          ...
          <article className="my-8 md:m-16 md:max-w-md">
            ...
            <h2 className="text-3xl leading-tight my-6 dark:text-white">
              El día que naciste{' '}
              <small className="block text-gray-600">Agustina</small>
            </h2>
            <p>
              Procesamiento digital. Fotografía tomada por mi hermano Daniel el
              día que nació Agustina, mi primera hija. Reencuadre y conversión a
              escala de grises para el análisis de datos. El programa proyecta
              elipses que crecen desde un punto de orígen. La continuidad de las
              líneas se encuentra en relación con el brillo de los pixeles.
              Resultado dibujado en plotter con microfibra negra sobre hoja
              natural.
            </p>
        ...
        <section className="bg-black text-gray-400 p-8">
          <div
            ...
            style={{
              backgroundImage:
                'url(/static/images/hasta-las-estrellas/concept2.jpg)'
            }}
          >
            ...
            <article className="my-8 md:m-16 md:max-w-md">
              <h2 className="text-3xl leading-tight mb-6 text-white">
                ...
                <small className="block text-gray-600">Andrea</small>
              </h2>
              <p>
                Buenos Aires, 16 de Septiembre de 1983, 21:00hs. Así se veía el
                cielo cuando nació Andrea, mi compañera, mi figura
                complementaria, con quién elijo compartir este mundo, hasta las
                estrellas.
              </p>
              <p>
                Visualización de datos. Imagen generada a partir de una
                colección de datos con las posiciones de las estrellas, vistas
                desde una fecha y lugar específico de nuestro espacio-tiempo.
              </p>
              <p>
                Posiciones obtenidas con Celestial Map, programa de código libre
                para visualizar datos GeoJSON. Instrucciones de dibujo
                simplificadas en programa vectorial. Dibujo realizado por
                plotter con marcador de pintura blanca sobre hoja negra.
              </p>
        ...
        <section className="container p-8 md:p-0 md:mx-auto md:my-24 md:grid grid-cols-3">
          <article className="max-w-sm mb-16">
            ...
            <h2 className="text-3xl leading-tight my-6 dark:text-white">
              Parte de tu Huella{' '}
              <small className="block text-gray-600">Joaquín</small>
            </h2>
            <p>
              Tintado en papel. Tinta china en la palma de la mano de Joaquín,
              mi segundo hijo, sello sobre papel. Máscara realizada con plotter
              de corte.
            </p>
            <div className="description mt-8">
          ...
          <figure className="flex-grow self-end md:mx-8">
            <img
              src="/static/images/hasta-las-estrellas/crece.jpg"
              alt="Crece"
              className="w-full shadow-2xl"
            />
          </figure>
        ...
        <figure>
          <img
            src="/static/images/hasta-las-estrellas/concept.jpg"
            alt="Concept"
            className="w-full"
          />
        </figure>
