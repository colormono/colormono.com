...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 text-white flex flex-col">
      <div className="w-full p-8 lg:p-16 max-w-[1280px] mx-auto">
        ...
        <div className="space-x-3">
          <ExternalLink href="https://photos.colormono.com">
            /photos
          </ExternalLink>
          {/* <Link href="/snippets">
